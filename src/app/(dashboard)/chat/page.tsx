...
export default function ChatPage() {
  ...
  // Set messages container height based on visible viewport
  useEffect(() => {
    ...
    const update = () => {
      ...
      el.style.height = `${visible - 64 - 56}px`; // header=64, input=56
    };
  ...
  return (
    <>
      {/* MOBILE: Three completely separate, sibling containers */}
      <div className="lg:hidden">
        {/* Container 2: Messages - completely separate from header and input */}
        <div
          ref={messagesContainerRef}
          className="fixed top-16 left-0 right-0 overflow-y-auto bg-parchment-300 dark:bg-parchment-900"
        >
          <div className="max-w-3xl mx-auto px-4 py-2">
            {/* Chat header info */}
            <div className="flex items-center space-x-3 py-2 border-b border-parchment-700/20">
        ...
        {/* Container 3: Input - completely separate, fixed at bottom */}
        <div className="fixed bottom-0 left-0 right-0 h-14 bg-parchment-100 dark:bg-indigo-900 border-t border-parchment-700/20 z-50">
          <div className="max-w-3xl mx-auto px-4 h-full flex items-center space-x-2">
            <Textarea
              value={input}
